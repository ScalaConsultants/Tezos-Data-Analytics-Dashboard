...
const Home = () => {
  return (
    <div>
      ...
      <p>2. We get a transaction list (25000) only once and save it to the cache. To reach this we created a simple 'local storage' based cache.</p>
      <p>3. Every 10 seconds we are getting a list of the latest transactions and add them to the cache.</p>
