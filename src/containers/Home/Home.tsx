...
const Home = (): React.ReactElement => {
  return (
    ...
    >
      ...
      <h3><a href="https://github.com/ScalaConsultants/Tezos-Data-Analytics-Dashboard" target="_blank">https://github.com/ScalaConsultants/Tezos-Data-Analytics-Dashboard</a></h3>
      <h2>General idea:</h2>
      <p>
